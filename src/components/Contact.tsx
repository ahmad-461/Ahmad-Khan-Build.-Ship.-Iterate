...
export default function Contact() {
  const contactLinks = [
    ...
    },
    {
      ...
      value: "linkedin.com/in/ahmad-khan-...",
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          {contactLinks.map((link) => (
            <a
              ...
              className="group block p-6 rounded-xl bg-[#1e293b] border border-[#334155]/60 hover:border-[#3b82f6]/40 hover:bg-[#1e293b]/80 transition-all duration-300 shadow-xl shadow-black/10 text-left"
            >
              <div className="flex justify-between items-start mb-6">
                ...
                <ArrowUpRight className="w-5 h-5 text-gray-500 group-hover:text-[#3b82f6] group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all duration-200" />
              </div>

              <div>
                <h3 className="text-xs font-semibold uppercase tracking-wider text-gray-400 mb-1 font-mono-accent">
                  {link.name}
                </h3>
                <p className="text-sm sm:text-base font-bold text-[#f8fafc] group-hover:text-[#3b82f6] transition-colors duration-200 break-all mb-4">
                  {link.value}
                </p>
                <span className="inline-flex items-center text-xs font-semibold text-[#3b82f6]/90 group-hover:text-[#3b82f6] transition-colors duration-200 font-mono-accent">
                  {link.actionText}
                </span>
              </div>
            </a>
