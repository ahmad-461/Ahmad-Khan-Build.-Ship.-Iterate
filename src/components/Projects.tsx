      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {projectsList.map((project) => {
            ...
            const isComingSoon = project.statusBadge === "Coming Soon";
              ...
              >
                ...
                <div className="p-7 sm:p-9 relative flex-grow flex flex-col justify-between">
                  <div>
                      ...
                      <span
                        className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold font-mono-accent border whitespace-nowrap ${
                          project.statusBadge === "Live"
                            ...
                            : "bg-transparent text-[#f8fafc]/40 border-[#334155]/60"
                        }`}
                      >
                        {project.statusBadge}
                      </span>
                    ...
                    {/* Title */}
                    <h3
                      className={`text-xl sm:text-2xl font-bold mb-3 transition-colors duration-200 ${
                        isComingSoon
                          ? "text-[#f8fafc]/60"
                          : "text-[#f8fafc] group-hover:text-[#3b82f6]"
                      }`}
                    >
                      {project.name}
                    </h3>
